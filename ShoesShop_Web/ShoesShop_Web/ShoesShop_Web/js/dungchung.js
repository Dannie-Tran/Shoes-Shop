...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo1.jpg" alt="LOGO Shoes" title="LOGO Shoes">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Shoes Store</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">ĐẠT NGON ZAI VÀ GIANG XINH ZAI</span></p>
    </div>`);
}
