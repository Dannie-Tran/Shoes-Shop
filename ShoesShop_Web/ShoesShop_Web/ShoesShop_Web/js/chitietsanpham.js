...
window.onload = function () {
    ...
    var tags = ["NIKE", "ADIDAS", "VANS", "PUMA", "CONVERSE"];
...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - Thế giới giày thể thao';
    ...
    var s = addThongSo('Size nam (VN)', sanPhamHienTai.detail.screen);
    s += addThongSo('Chiều dài chân', sanPhamHienTai.detail.os);
    s += addThongSo('Size nữ (VN)', sanPhamHienTai.detail.camara);
    s += addThongSo('Chiều dài chân', sanPhamHienTai.detail.camaraFront);
    s += addThongSo('Size nam (US)', sanPhamHienTai.detail.cpu);
    s += addThongSo('Chiều dài chân', sanPhamHienTai.detail.ram);
    s += addThongSo('Size nữ (US)', sanPhamHienTai.detail.rom);
    s += addThongSo('Chiều dài chân', sanPhamHienTai.detail.microUSB);
    s += addThongSo('Dụng cụ đo chân', sanPhamHienTai.detail.battery);
    info.innerHTML = s;
    ...
    // Hình nhỏ
    addSmallImg("img/products/adidas-swift-run.png");
    addSmallImg("img/products/adidas-swift-run.png");
    addSmallImg("img/products/adidas-swift-run.png");
